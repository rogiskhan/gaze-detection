...
public class DetectedFace : DetectedObject
{
    ...
    public void SetLandmarks(Point[] points)
    {
        ...
        if (null != Marks)
        {
            ...
            keysApplied += DefineSubObject(FaceElements.LeftEye, "LeftEye", 36, 41) ? 1 : 0;
            keysApplied += DefineSubObject(FaceElements.RightEye, "RightEye", 42, 47) ? 1 : 0; //qui specifichiamo quale prendere!!!!!!!!!!!!!!!!!
